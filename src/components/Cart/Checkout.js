...
const Checkout = (props) => {
  ...
  const postalControlledClasses = `${classes.control} ${
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={streetControlledClasses}>
        ...
        {!formInputValidity.street && <p>Please enter the valid Street name</p>}
      </div>
      <div className={postalControlledClasses}>
        <label htmlFor="postal">Postal Code</label>
        <input type="text" id="postal" ref={postalCodeInputRef} />
        {!formInputValidity.postalCode && (
          <p>Please enter the valid PostalCode (5 Character long) </p>
        )}
      </div>
      <div className={cityControlledClasses}>
        <label htmlFor="city">City</label>
        <input type="text" id="city" ref={cityInputRef} />
        {!formInputValidity.city && <p>Please enter the valid City name</p>}
      </div>
